...
format:
  html:
    ...
    toc-location: left
    toc-depth: 3
    toc-expand: true       # <-- THIS makes first-level headings expandable
    sidebar: true
    code-fold: true
...
Here we are merging data sets of distance calculation of girded travel cost to each site named site_joins.
