...
ggsave('images/avercoral_scenario.png', dpi = 300, height = 5, width = 8, unit = 'in')
```
...
ggsave('images/population_scenario.png', dpi = 300, height = 5, width = 8, unit = 'in')
...
```{r eval=FALSE}
# Adjust for inflation from original data 2017 to 2014
library(knitr)
...
kable(t, caption = "Summary of NPV_WTP_pluristic_nonpop", digits = 2)
```
